package com.totterman.polarbookshop.quotefunction.functions;
...
import com.totterman.polarbookshop.quotefunction.domain.QuoteService;
...
public class QuoteFunctions {
    ...
    Function<Mono<Genre>, Mono<Quote>> genreQuote(QuoteService quoteService) {
        return mono -> mono.flatMap(genre -> {
            log.info("Getting quote for genre {}", genre);
